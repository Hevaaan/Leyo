...
const UploadCategoryModel = ({close, fetchData}) => {
    ...
    const handleUploadCategoryImage = async(e)=>{
        ...
        try {
            ...
            const ImageResponse = response && response.data ? response.data : null;
            const imageUrl = ImageResponse && ImageResponse.data && ImageResponse.data.url ? ImageResponse.data.url : "";
